...
import { User, LogOut, Wallet, Coins, Settings, HelpCircle, Bell, Shield } from "lucide-react"
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full border border-purple-500/30 bg-black/40 p-0">
          ...
          <motion.div
            ...
            transition={{ repeat: isOpen ? 0 : Number.POSITIVE_INFINITY, duration: 2 }}
            className="absolute -top-1 -right-1 h-4 w-4 rounded-full bg-green-500 border border-black"
          />
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-64 bg-black/90 backdrop-blur-lg border-purple-500/30">
